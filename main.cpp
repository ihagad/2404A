...
void initialize() {
  ...
  ez::as::auton_selector.add_autons({
    ...
    //Auton("Sid can suck my", sixBallElevation),
  });
...
void opcontrol() {
  ...
  pros::Motor intake (15, true);
  pros::Motor shooting (5, true);
  pros::ADIDigitalIn limit (20);
  pros::Controller controller (CONTROLLER_MASTER);
  pros::ADIDigitalOut frontFlaps ('B');
  pros::ADIDigitalOut backFlapsR ('D');
  pros::ADIDigitalOut backFlapsL ('E');
  pros::ADIDigitalOut hangPiston ('A', true);
